            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger btn-sm add_btn" href="{{ url('/panel/') }}/menu-list">
                            All Data
                        </a>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('panel/menu-update/'.$Menu->menu_id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control" value="{{ $Menu->menu_title }}" name="menu_title" placeholder="Title">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="text-center">
                                        <img class="img-fluid w-100 rounded" src="{{asset($Menu->menu_image)}}" alt="Photo">
                                    </div>
                                </div>
