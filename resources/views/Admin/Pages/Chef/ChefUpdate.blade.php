            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger btn-sm add_btn" href="{{ url('/panel/') }}/chef-list">
                            All Data
                        </a>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('panel/chef-update/'.$Chef->chef_id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $Chef->chef_description }}" name="chef_description" placeholder="Description">
                                    </div>
                                </div>
