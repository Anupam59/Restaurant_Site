            ...
            <!-- Default box -->
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger btn-sm add_btn" href="{{ url('/panel/') }}/common-page-create">
                            ...
                            @foreach($CommonPage as $key=>$CommonPageItem)
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <a class="btn btn-primary btn-sm" href="{{ url('/panel/') }}/common-page-edit/{{ $CommonPageItem->page_id }}">
