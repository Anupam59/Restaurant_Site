            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('panel/common-page-update/'.$CommonPage->page_id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $CommonPage->page_description }}" name="page_description" placeholder="Description">
                                    </div>
                                </div>
