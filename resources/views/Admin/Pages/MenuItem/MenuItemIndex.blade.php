            ...
            <!-- Default box -->
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger btn-sm add_btn" href="{{ url('/panel/') }}/menu-item-create">
                            ...
                            @foreach($MenuItem as $key=>$MenuItemItem)
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <a class="btn btn-primary btn-sm" href="{{ url('/panel/') }}/menu-item-edit/{{ $MenuItemItem->menu_item_id }}">
